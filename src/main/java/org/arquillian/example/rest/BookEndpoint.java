...
public class BookEndpoint
{
   ...
   {
      TypedQuery<Book> findByIdQuery = em.createQuery("SELECT DISTINCT b FROM Book b LEFT JOIN FETCH b.speakers WHERE b.id = :entityId ORDER BY b.id", Book.class);
   ...
   {
      TypedQuery<Book> findAllQuery = em.createQuery("SELECT DISTINCT b FROM Book b LEFT JOIN FETCH b.speakers ORDER BY b.id", Book.class);
